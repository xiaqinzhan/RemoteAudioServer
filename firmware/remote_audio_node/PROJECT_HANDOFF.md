...
- **固件版本**：2.2.0（长连接保活版；协议字段与 2.0.0/2.1.0 完全一致，只是在 2.1.0
  之上加了 WS 协议级 ping、重连提速与重连自动续流，见 10.21）
...
| 宏 | 默认值 | 说明 |
|---|---|---|
| `RAN_FW_VERSION` | "2.2.0" | hello.fw 字段 |
| `RAN_WIFI_SSID` / `RAN_WIFI_PASSWORD` | myssid/mypassword | |
